...
const REPORTS = [
  {
    ...
    sub: "Paid / pending by unit, this month",
  },
  {
    id: "dues",
    icon: "⚠️",
    title: "Outstanding Dues",
    sub: "Total balance owed, by unit",
  },
  {
    id: "expenses",
    icon: "💸",
    title: "Expense Report",
    sub: "Itemised, grouped by category",
  },
  {
    id: "income-vs-expense",
    icon: "📊",
    title: "Income vs Expense",
    sub: "Monthly collection vs spend",
  },
];
...
export default async function ReportsIndexPage() {
  ...
  return (
    <div className="space-y-4">
      <h1 className="text-xl font-bold text-teal-deep">Reports</h1>
      {!propertyId ? (
        <p className="text-sm text-muted">Add a property first.</p>
      ) : (
